...
\section{Utente Loggato, Dati in Tabella}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{RF7: Visualizzazione Analisi} \begin{itemize}
...
\section{Selezione di un Quartiere}
    ...
    \begin{itemize}
        ...
        \end{itemize} 
        \item \textbf{RF8: Visualizzazione Analisi Storico} \begin{itemize}
...
\section{Caricamento sondaggi e modifica dati}
    ...
    \begin{itemize}
        \item \textbf{RF9: Visualizzazione dati sondaggisti} \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{RF12-13-14: Approvazione e disapprovazione sondaggi, modifica dati statici, modifica utenti abilitati} \begin{itemize}
