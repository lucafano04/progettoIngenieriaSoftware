...
\newcommand{\ProjectTitle}{Nome del progetto}
\newcommand{\ProjectDescription}{Descrizione del progetto}
    ...
    \begin{titlepage}
        ...
        \begin{center}
            \begin{tabular}{|l|l|l|c|}  
                \hline
                {\cellcolor[rgb]{0,0.502,1}}\textcolor{white}{\textbf{Doc. Name}}   & D1 - \ProjectTitle - \ProjectDescription & {\cellcolor[rgb]{0,0.502,1}}\begin{tabular}[c]{@{}>{\cellcolor[rgb]{0,0.502,1}}l@{}}\textcolor{white}{\textbf{Doc.}}\\\textcolor{white}{\textbf{Number}}\end{tabular} & D1 V\version  \\ 
                \hline
