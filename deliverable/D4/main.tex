...
\newcommand{\FileName}{D4-\ProjectTitleShort-Report Finale}

% Definizione dei dati del documento
\title{Report Finale - \ProjectTitle}
...
\hypersetup{
    ...
    pdfsubject={Report Finale},
    pdfkeywords={\ProjectTitle, Report Finale, Comune di Trento, UniTN}
}
...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \begin{center}
            \begin{tabular}{|l|l|l|c|}  
                ...
                \hline
                {\cellcolor[rgb]{0,0.502,1}}\textcolor{white}{\textbf{Description}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}>{\cellcolor[rgb]{1,1,1}}l@{}} {Report Finale del progetto: organizzazione del lavoro, ruoli, tempo complessivo}\\{ di ciascun membro dedicato al progetto, criticità, autovalutazione}\end{tabular}} \\
                \hline
            \end{tabular}
        \end{center}
    ...
    \include{chapters/01-organizzazioneMetodologia}
    \include{chapters/02-ruoliAttivita}
    \include{chapters/03-caricoLavoro}
    \include{chapters/04-criticita}
    \include{chapters/05-autovalutazione}
    % \afterpage{\blankpage} % Uncomment this line if to print as a booklet
\end{document}